...
\begin{figure}[ht]
  \begin{subfigure}[b]{0.5\linewidth}
    \includegraphics[width=\linewidth]{assets/cemicro-element-editor.png}
...
And with that, the containerization of the CEMicro application is complete. Not the single command \inlinecode{docker-compose up} takes care of building and starting all three parts of the application, including running the migrations for a new database, and it is then usable through the browser.
