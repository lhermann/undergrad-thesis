...
- How was the "is" situation when starting?
...
- High-Level Overview of Illustration

- The complexity of POS / CE Properties
...
\begin{itemize}
  ...
  \item Challange/Example: Devs didn't know that CEs are not unique per template
\end{itemize}
...
How can the complexity of CEs be exposed in a more straightforward way?
